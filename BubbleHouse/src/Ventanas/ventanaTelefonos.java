...
public class ventanaTelefonos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 80, 190, 30));
    ...
    private void lblAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAgregarMouseClicked
        ...
        String apellidos = txtTelefono.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaTelefonos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
